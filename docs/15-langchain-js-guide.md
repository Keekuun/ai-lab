...
const docs = await splitter.createDocuments(
    [markdown],
    [{ source: "docs/08-build-first-agent.md" }],
);
```
...
**深挖 API：** [LangChain.js 专系列（01～16）](./langchain/index.md) · [LangGraph.js 专系列（01～13）](./langgraph/index.md)（参数、场景、底层原理分项展开）。
...
专系列 API 深挖见 [langchain/README](./langchain/index.md)。**校对日期 2026-06-11**；撰写基准 **LangChain.js v1**（`langchain@1.4.6`）。本仓库 [blog-assistant](https://github.com/Keekuun/keekuun.github.io/tree/master/apps/blog-assistant/) 仍为 **0.3.x**，import 可能不同 — 详见专系列 README「版本基准与维护」。
...
**总索引：** [README](/) · **专系列：** [LangChain](./langchain/index.md) · [LangGraph](./langgraph/index.md) · [Mastra](./mastra/index.md) · **参考：** [LangChain.js 文档](https://js.langchain.com/) · [LangSmith](https://smith.langchain.com/) · [LangGraph.js](https://langchain-ai.github.io/langgraphjs/)
