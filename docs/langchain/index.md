...
**与 LangGraph 专系列的关系：** LangChain 管「单步能力」；多步编排、checkpoint 见 [LangGraph 专系列](../langgraph/index.md)。
...
| **本仓库 demo** | [blog-assistant](https://github.com/Keekuun/keekuun.github.io/tree/master/apps/blog-assistant/) 当前为 **0.3.x** 栈，见下表 |
...
| 图编排、checkpoint | [16 LangGraph 实战](../16-langgraphjs-practice.md) | [LangGraph 专系列](../langgraph/index.md) |
...
**返回主线：** [AI Agent 系列总索引](/) · [完整路线图](../ai-agent-learning-roadmap.md)
