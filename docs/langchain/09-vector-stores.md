...
**系列导航：** [08 Embeddings](./08-embeddings.md) · [专系列首页](/langchain/) · 下一篇：[10 Output Parsers](./10-output-parsers.md)
...
**上一篇：** [09 Vector Stores](./09-vector-stores.md) · **专系列：** [专系列首页](/langchain/)
