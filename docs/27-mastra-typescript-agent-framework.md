...
> [15 LangChain 生态](./15-langchain-js-guide.md) 讲「积木 + 自选组装」；[20 Vercel AI SDK](./20-vercel-ai-sdk-guide.md) 讲「Chat UI 流式体验」；**Mastra** 走第三条路：**TS 原生一体化**——Agent、Workflow、RAG、Memory、Scorers、Studio 等收进同一框架。下文对照表为**选型摘要**；具体 API 以 [Mastra Docs](https://mastra.ai/docs) 为准，专系列 [mastra/](./mastra/index.md) 逐条对齐官方参考。
...
- **LangChain/LangGraph**：你要完全掌控图、checkpoint、和 Python 生态对齐 → 选 LC/LG + [专系列](./langchain/index.md)
- **AI SDK**：Next 项目主要是 **Chat UI + 轻量 Tool** → 选 [20](./20-vercel-ai-sdk-guide.md)
- **Mastra**：TS 团队要 **Agent + Workflow + RAG + Trace + Scorers 一套齐** → 选 Mastra + [专系列](./mastra/index.md)
...
- 要 **极细粒度** 自定义 checkpoint 格式、图语义 → [LG 专系列](./langgraph/index.md)
...
| **详表与维护** | [mastra/README — 版本基准与维护](./mastra/index.md#版本基准与维护) |
...
**Mastra 专系列（API 深挖）：** [mastra/README](./mastra/index.md)
...
**总索引：** [README](/) · **LC/LG 专系列：** [langchain](./langchain/index.md) · [langgraph](./langgraph/index.md)
