...
图 API 深挖见 [langgraph/README](./langgraph/index.md)。**校对日期 2026-06-11**；撰写基准 **LangGraph.js 1.x**（`@langchain/langgraph@1.4.4`）。本仓库 [blog-assistant](https://github.com/Keekuun/keekuun.github.io/tree/master/apps/blog-assistant/) 锁定 **^0.4.9** — 详见专系列 README「版本基准与维护」。
...
**深挖 API：** [LangGraph 专系列（01～13）](./langgraph/index.md) · [LangChain 专系列（01～16）](./langchain/index.md)

**总索引：** [README](/) · **参考：** [LangGraph.js 文档](https://langchain-ai.github.io/langgraphjs/) · [Graph API](https://docs.langchain.com/oss/javascript/langgraph/graph-api) · [Anthropic: Building effective agents](https://www.anthropic.com/research/building-effective-agents)
