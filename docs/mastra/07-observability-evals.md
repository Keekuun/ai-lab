...
**系列导航：** [06 RAG](./06-rag-vector.md) · [专系列首页](/mastra/) · 下一篇：[08 Next.js](./08-nextjs-integration.md)
...
本站 [blog-assistant eval](https://github.com/Keekuun/keekuun.github.io/tree/master/apps/blog-assistant/eval/golden.json) 用 **`expectContains`** 做冒烟回归，属于 **CI 补充**，与 Scorers 并行：
