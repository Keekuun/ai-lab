...
> Route 示例摘自 [Next.js 指南](https://mastra.ai/guides/getting-started/next-js)、[Deployment overview](https://mastra.ai/docs/deployment/overview)。对照本站 [blog-assistant](https://github.com/Keekuun/keekuun.github.io/tree/master/apps/blog-assistant/) 与 [20 AI SDK](../20-vercel-ai-sdk-guide.md)。

**系列导航：** [07 Observability](./07-observability-evals.md) · [专系列首页](/mastra/)
...
**上一篇：** [07 Observability](./07-observability-evals.md) · **专系列：** [专系列首页](/mastra/) · **主线：** [AI 系列索引](/)
