...
- 不写博客、不改数据库
- 不替代全站搜索（可与 [AI 检索](https://blog.zkkysqs.top/categories/AI/) 并存）
- 不做开放域「任意代码执行」Tool
...
| 索引 | `scripts/index-blog.ts` 读 `docs/*.md` |
...
**深挖：** [LangChain 专系列](./langchain/index.md) · [LangGraph 专系列](./langgraph/index.md)

**总索引：** [README](/) · **路线图：** [ai-agent-learning-roadmap](./ai-agent-learning-roadmap.md)
